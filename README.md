...
| ------------- | ------------- | ------------- |
| [Compiler Project](https://github.com/Luis-Leyva/ProyectoCompilador)  | Small compiler developed using Python 3.11 and Pyparsing package | Finished (Handed in) |
| [Anomalies Dashboard](https://github.com/CarlosGlzMx/TableroDeAnomalias)  | Web App that connects an AI model and database that displays a anomaly analysis dashboard. Created using JavaScipt, React, Python and SQL. School project for Ternium | Finished (Handed in)|
